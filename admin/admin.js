// Глобална функция за logout на админа
// Премахва логин информацията от sessionStorage и localStorage,
// скрива поздравителния блок, премахва таблицата и показва отново логин попъпа
...
//DOM Ready: обработка на визуализацията и зареждането на потребителите
document.addEventListener("DOMContentLoaded", () => {
  ...
  // Заявка към бекенда за зареждане на всички потребители
  fetch(`${window.location.origin}/api/users`)
    ...
    .then((users) => {
      users.forEach((user) => {
        ...
        // При клик отваря попъпа с информация за потребителя
        ...
        editIcon.innerHTML = `
          <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" fill="#999" viewBox="0 0 24 24">
            <path d="M3 17.25V21h3.75L17.81 9.94l-3.75-3.75L3 17.25zM21.41 
              6.34c.38-.38.38-1.01 0-1.39l-2.34-2.34a.9959.9959 
...
function createAdminLoginPopup() {
  ...
  document.getElementById("adminLoginButton").addEventListener("click", () => {
    ...
    const usernameRegex = /^[a-zA-Z0-9_.]+$/; // само латиница, цифри, _ и .
    ...
    // -----------------------
    // Ако всичко е наред, продължаваме с fetch заявката
